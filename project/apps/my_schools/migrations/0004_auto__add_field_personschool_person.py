...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('my_schools_personschool', 'person', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['my_schools.Person']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonSchool.person'
        db.delete_column('my_schools_personschool', 'person_id')
    ...
    models = {
        ...
        'my_schools.personschool': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['my_schools.Person']"}),
